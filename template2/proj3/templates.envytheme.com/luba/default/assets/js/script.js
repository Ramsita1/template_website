jQuery(function ($) {
    ...
    // new js date: 03/01/2021
    // header-carousel-four
    $('.header-carousel-four').owlCarousel({
        loop: true,
        margin: 100,
        nav: false,
        dots: true,
    ...
    $(".testimonial-review-carousel").owlCarousel({
        loop: false,
        margin: 30,
        nav: false,
        dots: true,
    ...
    // Buy Now Btn
	$('body').append("<a href='https://themeforest.net/checkout/from_item/29315566?license=regular&support=bundle_6month&_ga=2.19558456.1095024147.1646685914-918236941.1644836235' target='_blank' class='buy-now-btn'><img src='assets/images/envato.png' alt='envato'/>Buy Now</a>");
...
function setTheme(themeName) {
    localStorage.setItem('luba_theme', themeName);
    document.documentElement.className = themeName;
}

// function to toggle between light and dark theme
function toggleTheme() {
    if (localStorage.getItem('luba_theme') === 'theme-dark') {
